                ...
                <thead className=' border-b-[.5px] border-solid border-[#0000004D] '>
                    <tr>
                        ...
                        <th className='p-[15px] text-start'>
                            <input className='border-[1.5px] border-solid border-black w-[18px] h-18px ' type="checkbox" name="check" id="check" />
                        </th>
                        <th className='text-[16px] font-normal py-[17px] ps-[7px] text-start'>Name</th>
                    ...
                    {data.map((item, i) => {
                        return (
                            <tr key={i} className='py-[10px]'>
                                ...
                                <td className=' py-[17px] px-[7px]  m-auto'>
